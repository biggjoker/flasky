...
(function () {
    ...
    Morris.Grid = (function (_super) {
        ...
        Grid.prototype.setData = function (data, redraw) {
            ...
            this.ymin = (this.ymin == null) ? this.ymax : this.ymin;
        ...
        Grid.prototype.yAxisFormat = function (label) {
            if (this.options.yLineAb === true) {
                return "" + (Morris.abNumber(label));
            } else {
